...
"""
Solution:
    this server only check our private key don't be 1, but we can use a private key with (E.order() + 1) * P = P
    due to E.order() * any point in the E will be zero

the parameters of Elliptic Curve refer: https://neuromancer.sk/std
"""
